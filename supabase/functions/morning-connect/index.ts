...
// Stores Morning/GreenInvoice credentials server-side and marks integrations as connected.
//
// Required secrets:
// - SUPABASE_URL
...
//
// Input:
// { agencyId: string, companyId: string, apiKey: string, baseUrl?: string }
//
// Stores into public.integration_secrets(provider='morning').secret:
// { id: companyId, secret: apiKey, base_url }

          ...
          {toasts.map(toast => {
            ...
            return (
              <motion.div
                ...
                className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-lg border ${styles} backdrop-blur-md shadow-2xl min-w-[300px] max-w-md text-foreground`}
              >

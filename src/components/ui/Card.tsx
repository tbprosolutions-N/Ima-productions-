...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-[var(--modu-radius-lg)] border border-border bg-card text-card-foreground shadow-sm transition-all duration-200',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex flex-col gap-3 p-6 md:p-6', className)}
    {...props}
  />
));

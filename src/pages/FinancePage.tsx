...
import { DollarSign, CheckCircle, Circle, Upload, Download, Calendar, Pencil, Trash2, Plus, LayoutGrid, List, Eye, FolderOpen, FileText } from 'lucide-react';
...
const FinanceCashFlowChart = React.lazy(() => import('@/components/charts/FinanceCashFlowChart'));
...
const FinancePageContent: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Cash flow graph — lazily loaded so recharts (~372 KB) is only fetched when data exists */}

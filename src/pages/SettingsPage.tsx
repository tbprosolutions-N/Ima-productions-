                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 text-xs text-muted-foreground">
                  <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
                    ...
                    <ul className="list-disc pr-5 space-y-1">
                      ...
                      <li>חיבור אינטגרציות (Morning/Drive) והגדרת מפתחות. Calendar פועל אוטומטית.</li>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-3">
              {[
                ...
                { q: 'איך מייצאים אירועים ליומן?', a: 'הזמנות ל-Google Calendar נשלחות אוטומטית בעת שמירת אירוע (אם סומן "שלח הזמנה"). בנוסף ניתן להשתמש ב-"הוסף ל-Google Calendar" לפתיחת היומן.' },

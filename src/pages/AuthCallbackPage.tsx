 ...
 * We show any error from the URL and diagnose timeout so the user knows why login failed.
 */
import React, { useEffect, useRef, useMemo } from 'react';
import { useNavigate, useSearchParams } from 'react-router-dom';
import { useAuth } from '@/contexts/AuthContext';
import { getAuthCallbackRedirectUrl, notifyAuthPopupDone } from '@/lib/supabase';

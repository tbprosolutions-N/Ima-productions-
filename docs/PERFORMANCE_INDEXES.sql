...
-- agency_id indexes (multi-tenancy / RLS filters)
...
-- events: event_date for date-range queries (calendar, reports, period summary)
CREATE INDEX IF NOT EXISTS idx_events_event_date ON public.events(event_date);

-- Composite: agency + date (dashboard, calendar)
